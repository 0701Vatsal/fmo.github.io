  ...
  <nav><div class="button2">
    <form method="get" align="center" action="signupp.php">
    <button type="submit">signup</button>
  </form></div></nav>
  <br>
 <div class="button2">  
   <form method="get" align="right" action="registerjobseeker.php">
  <button type="submit">Register Jobseeker</button></form>
</div>
    ...
    <p class="login-box-msg" align="center">Sign in to start your session</p> <br>
...
<br>
    <div class="button2"> 
          <button type="submit" name="login" class="btn btn-primary btn-block btn-flat">Sign In</button></div>
    </form>

  <br>
 <!-- <form align="center" method="get" action="http://localhost/online-Maid-service-master/empp_login.php">
  <h2> If you are employer than please click on Employer button</h2>      
  <div class="button2">
      
  <button type="submit" onclick="http://localhost/online-Maid-service-master/empp_login.php">EMPLOYER</button></div>
  </form>
 ...
 <!-- <form align="center" method="get" action="http://localhost/online-Maid-service-master/emp_login.php"> 
  ...
  <div class="button2">
  <button type ="submit" onclick="http://localhost/online-Maid-service-master/login1.php">JOBSEEKER</button></div> </form>
