...
<header><div class="container">
  ...
  <br>
 <div class="button2">  
   <form method="get" align="left" action="registerjobseeker.php">
  <button type="submit">Register Jobseeker</button></form>
    ...
    <form action="" method="post" align="center">
        ...
        <input type="checkbox" name="checkbox" required><a href="tnc.php">I agree</a>
<br><br>  
    <div class="button2"> 
...
if (isset($_POST['login'])) 
{
    ...
    {
     	echo "<h1> Invalid email or password.Please sign up if you are new user.</h1>";
