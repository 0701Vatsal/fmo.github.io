...
<head>
    ...
    <title>SIGNUP FORM FOR EMPLOYER</title>
    <link rel="stylesheet" href="http://localhost/project/style.css">
    <script type="text/javascript">
                    function conf()
                      {
                          var con=confirm("YOU ARE COMPLETED YOU SIGNUP... WELCOME, PLEASE LOGIN");
                      }
</script>
   <style>
            #circle-btn { 
...
<header><h1>Signup FORM FOR EMPLOYER</h1></header>
    ...
    <form> 
        ...
        <p>Email: <input type="email" name="email" id="email" placeholder="Emaail" required></p>
        <p>Address: <textarea name="address" id="address" placeholder="Address" cols="20" rows="5"></textarea></p>
        ...
        <p>Contact Number: <input type="number" oninvalid="alert('Must contain 10 digit number');" pattern=".{10}"  name="contactnumber" placeholder="Contact Number" id="contactnumber" required></p>
        <div class="button2">
        <button type="submit"  name="Submit" onClick="conf()"/>Signup</button>
...
$query= "INSERT INTO employer_signup  VALUES('$na' , '$ge' , '$em' , '$add','$ps','$pc', '$cn')";
