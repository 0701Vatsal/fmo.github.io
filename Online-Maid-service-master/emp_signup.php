...
<body>
    ...
    <header>Signup FORM FOR EMPLOYER</header>
    ...
    <form> 
        ...
        <p>Contact Number: <input type="number" name="contactnumber" id="contactnumber" required></p>
        <div class="button2">
    ...
    <footer>
            <a href="#">FAQ</a>
            <a href="#">Contact Us</a>
            <a href="#">&copy;2021 all rights reserved by Your Pharmacy</a>
